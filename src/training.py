...
def training(training_data, test_data, config_path="config.yaml"):
    ...
    try:
        ...
        (X_train, y_train), (X_val, y_val), (X_test, y_test) = get_data(training_data, test_data, validation_datasize, logger)
